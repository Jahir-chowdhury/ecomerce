...
class WishListController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(Auth::check()){
            ...
            $ven_wish = WishList::where('vendor_product_id',$ven_product->id ?? '')->first();
            if ($wish !=null || $ven_wish !=null) {
    ...
    public function destroy($slug)
    {
        ...
        $ven = VendorProduct::where('slug',$slug)->first();
        
        if($product != null){
             WishList::where('product_id',$product->id)->delete();
        }else{
             WishList::where('vendor_product_id',$ven->id)->delete();
        }
