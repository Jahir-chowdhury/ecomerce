                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="product-details product-details-sidebar">
                                        <h1 class="product-title">{{ optional($product)->product_name }}</h1>

                                        <div class="product-price">
                                            <span id="sale_price" class="new-price">{{ optional($product->get_attribute[0])->sale_price }} TK</span>
                                            <span class="old-price"><del id="promo_price">{{ optional($product->get_attribute[0])->promo_price }} TK</del></span>
                                        ...
                                        <div class="details-filter-row details-row-size">
                                            ...
                                            <div class="product-nav product-nav-dots">
                                                    <a href="#" class="active" style="background: {{ optional($product)->color }}"><span
                        ...
                        <div class="sidebar sidebar-product" style="max-height: 59rem; min-height:10rem; overflow-y: scroll;">
                            <div class="widget widget-products">
                                ...
                                <div class="products">
                                    ...
                                    @if ($pro->get_brand->id == optional($product)->brand_id && $pro->slug != optional($product)->slug)
                                    ...
                                    <div class="product product-sm">
                                        ...
                                        <div class="product-body">
                                            <h5 class="product-title"><a href="{{route('quick',$pro->slug)}}">{{$pro->product_name}}</a></h5><!-- End .product-title -->
                                            <div class="product-price">
                                                @foreach($pro->get_attribute->unique('product_id') as $attr)
                                                <span class="new-price">{{ optional($attr)->sale_price }} Tk.</span>
                                                <span class="old-price">{{ optional($attr)->promo_price }} Tk.</span>
                                                @endforeach
                                            </div><!-- End .product-price -->
                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow owl-loaded owl-drag"
                            ...
                            <div class="owl-stage-outer">
                                <div class="owl-stage"
                                    ...
                                    @foreach ($products as $pro)
                                        @if (optional($pro)->sub_child_category_id == optional($product)->sub_child_category_id && optional($pro)->slug != optional($product)->slug)
                                    <div class="owl-item active" style="width: 202.75px; margin-right: 20px;">
                                        ...
                                        <div class="product prod_hover product-7 text-center">
                                            ...
                                            <figure class="product-media">
                                                <a href="{{route('quick',$pro->slug)}}">
                                                    <img style="width: 100%;" class="img_mbl" src="{{ asset('/images/' . $avtr->front) }}" alt="Product image"
                                                        class="product-image">
                                                </a>
                                            ...
                                            @endforeach
                                            <div class="product-body">
                                                <h3 class="product-title"><a href="{{route('quick',$pro->slug)}}">{{$pro->product_name}}</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    @foreach($pro->get_attribute->unique('product_id') as $attr)
                                                    <span class="new-price">{{ optional($attr)->sale_price }} Tk.</span>
                                                    <span class="old-price">{{ optional($attr)->promo_price }} Tk.</span>
