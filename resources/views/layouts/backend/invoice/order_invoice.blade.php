                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tbody>
                                @foreach ($datas->get_order_details as $pro)
                                    ...
                                    @endif
                                    @if($pro->get_vendor_product)
                                    <tr>
                                        <td class="no">{{ $pro->id }}</td>
                                        <td class="text-left">{{ $pro->get_vendor_product->product_name }}</td>
                                        <td class="unit">{{ $pro->qty }}</td>
                                        <td class="qty">{{ $pro->shipp_charge }}</td>
                                        <td class="total">{{ $pro->get_vendor_product->sale_price }}</td>
                                        <td class="total">{{ $pro->total }}</td>
                                    </tr>
                                    @endif
                                @endforeach
