                        ...
                        <div class="panel-body">
                            <form style="margin-bottom: 10px;
                                ...
                                <div class="form-group">
                                    <label class="mr-sm-2">Ad Link</label>
                                    <textarea id="link" name="link" type="text"
                                    class="form-control" placeholder="Enter ad link"></textarea>
                                </div>
                                <div class="form-group">
                ...
                <div class="card col-7">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr role="row">
                                    <th class="sorting_asc" style="width: 166px;">Banar</th>
                                    <th class="sorting_asc" style="width: 166px;">Link</th>
                                    <th class="sorting_asc" style="width: 166px;">Position</th>
                                    <th class="sorting" style="width: 219px;">Status</th>
                            ...
                            <tbody>
                                @foreach ($ads as $ad)
                                    <tr>
                                        ...
                                        <td>
                                            {{ Illuminate\Support\Str::limit($ad->link, 10) }}
